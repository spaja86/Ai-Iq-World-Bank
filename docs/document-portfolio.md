...
| `covecnost-narativni-epilog-plan.md` | Public Output | narrative epilog framework | working | public-safe | `README.md`, `governance/document-lifecycle.md`, `docs/repository-operating-model.md`, `standards/glossary.md` | medium | Controlled narrative framing for courage, learning, innovation, and human potential |
