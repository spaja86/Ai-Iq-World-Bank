...
| `standards/indekurilanc-standard.md` | Standards | scoring standard | approved | canonical/internal standard | standards lane | canonical / standards | `governance/repo-charter.md`, `governance/document-lifecycle.md`, `standards/glossary.md` | high | Canonical source for INDEKURILANC behavior |
...
| `docs/repository-operating-model.md` | Architecture | operating model | working | public-safe | portfolio + shared lane | contributor routing + creator/public-safe framing | `README.md`, `governance/repo-charter.md`, `governance/document-lifecycle.md`, `docs/document-portfolio.md`, `docs/repository-roadmap.md`, `docs/future-data-model.md`, `config/sensitive-content-review-checklist.md` | medium | Primary coordination document for ownership, approvals, lanes, work cycle, and release gates |
...
| `docs/repository-roadmap.md` | Roadmap | delivery plan | working | public-safe | portfolio lane | contributor / architecture | `docs/document-portfolio.md`, `governance/repo-charter.md`, `config/validate_repository.py` | medium | Delivery sequencing across product and docs |
