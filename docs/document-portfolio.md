...
| `standards/indekurilanc-standard.md` | Standards | scoring standard | approved | canonical/internal standard | standards lane | canonical / standards | `script.js`, `standards/glossary.md`, `governance/repo-charter.md` | high | Canonical source for INDEKURILANC behavior |
